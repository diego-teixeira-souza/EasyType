#ifndef IS_INCOMPLETE_ARRAY_HPP
#define IS_INCOMPLETE_ARRAY_HPP
...
class IsIncompleteArray<T [] [s2] [s3] [s4] [s5] [s6] [s7] [s8] [s9] [s10] [s11] [s12] [s13] [s14] [s15]>:
public easytype::basis::TrueType{};

template<typename T>
class IsIncompleteArray:public easytype::basis::FalseType{};
